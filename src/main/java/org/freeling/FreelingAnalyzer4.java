...
public class FreelingAnalyzer4 {

    private static FreelingAnalyzer4 instance;
    ...
    public static FreelingAnalyzer4 getInstance() {

        if (instance == null)
            instance = new FreelingAnalyzer4();
        return instance;
    }
