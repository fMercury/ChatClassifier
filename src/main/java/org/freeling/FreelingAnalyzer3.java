...
import edu.upc.freeling3.Alternatives;
import edu.upc.freeling3.ChartParser;
import edu.upc.freeling3.Depnode;
import edu.upc.freeling3.HmmTagger;
import edu.upc.freeling3.ListPairStringInt;
import edu.upc.freeling3.ListSentence;
import edu.upc.freeling3.ListSentenceIterator;
import edu.upc.freeling3.ListWord;
import edu.upc.freeling3.ListWordIterator;
...
public class FreelingAnalyzer3 {
    
    private static FreelingAnalyzer3 instance;

    private static final String LANG = "es";
    private static final String FREELING_DIR = "src/main/resources/freeling3.1/";
...
//    private Ukb disambiguator;
    ...
    public static FreelingAnalyzer3 getInstance() {
        
        if (instance == null)
            instance = new FreelingAnalyzer3();
        return instance;
    }
