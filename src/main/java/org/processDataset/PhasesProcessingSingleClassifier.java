...
public class PhasesProcessingSingleClassifier extends ProcessDataset {
     ...
     */
    public PhasesProcessingSingleClassifier(Weka wekaClassifier, boolean useFreeling, boolean useEasyProcessing) {
