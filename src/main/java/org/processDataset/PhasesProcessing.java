...
public class PhasesProcessing extends ProcessDataset {
    ...
    public String train(String fileName) {
        ...
        // Clasificador 1
        wekaPhase2Classifier1.filterByCathegory("2", "last");
        ...
        // Clasificador 2        
        wekaPhase2Classifier2.filterByCathegory("2", "first");
        ...
        // Clasificador 1
        wekaPhase3Classifier1.filterByCathegory("2", "2,3,4");
        ...
        // Clasificador 2
        wekaPhase3Classifier2.filterByCathegory("2", "1,2,3");
        ...
        // Clasificador 3       
        wekaPhase3Classifier3.filterByCathegory("2", "1,2,4");
        ...
        // Clasificador 4       
        wekaPhase3Classifier4.filterByCathegory("2", "1,3,4");
        ...
        phase3.setResults(wekaPhase3Classifier1.getEvaluationResults() + wekaPhase3Classifier2.getEvaluationResults() + 
        				  wekaPhase3Classifier2.getEvaluationResults() + wekaPhase3Classifier4.getEvaluationResults());
    ...
    public void classify(String fileName, String trainFileName) {
        ...
        String phase2ClassifyingResults = wekaPhase2Classifier1.classify(modelFileName + "-phase2-classifier1.dat", phaseFileName, labeledFileNamePhase2, "3");
        phase2ClassifyingResults += wekaPhase2Classifier2.classify(modelFileName + "-phase2-classifier2.dat", phaseFileName, labeledFileNamePhase2, "3");
        ...
        String phase3ClassifyingResults = wekaPhase3Classifier1.classify(modelFileName + "-phase3-classifier1.dat", phaseFileName, labeledFileNamePhase3, "4");
        phase3ClassifyingResults += wekaPhase3Classifier2.classify(modelFileName + "-phase3-classifier2.dat", phaseFileName, labeledFileNamePhase3, "4");
        phase3ClassifyingResults += wekaPhase3Classifier3.classify(modelFileName + "-phase3-classifier3.dat", phaseFileName, labeledFileNamePhase3, "4");
        phase3ClassifyingResults += wekaPhase3Classifier4.classify(modelFileName + "-phase3-classifier4.dat", phaseFileName, labeledFileNamePhase3, "4");
